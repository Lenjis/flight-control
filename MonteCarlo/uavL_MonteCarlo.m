...
% state
% --------------
% U, V, W,  phi,theta, psi,  P,Q,R,  PN,PE,H, Lon, Lat
%
% Definition
% ----------
% [Vt,alpha,beta]          ----- V alpha  beta
...
global pcl pcd pcm pcQ pclele peng pwind pcweight pcXG;       % Add deviation
...
L = qs * (CL0 * pcl + CL_ele * ele * pclele);
...
M = qs * cbar * (CM0 * pcm + CM_ele * ele + (CM_Q * pcQ * Q) * cbar / Vt / 2) + L * pcXG; % + CM_dalpha*dalpha
