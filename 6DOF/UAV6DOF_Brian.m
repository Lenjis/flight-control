function [sys, x0, str, ts] = UAV6DOF_Brian(t, x, u, flag)
    %
...
function [sys,x0,str,ts]=mdlInitializeSizes
    ...
    %动力数据
    Vt = 36;
    alpha_deg = 0.123465930766916;
    beta_deg = 0;
    theta = 0.123465930766916;
    H = 333; %alpha_deg 配平后
    x0 = [Vt; alpha_deg / rad2deg; beta_deg / rad2deg; 0; 0; H; 0; 0; 0; 0; theta / rad2deg; psi_hmr / rad2deg];
...
function sys=mdlOutputs(t,x,u)
    ...
    %-------输出量--------------
    sys = [
            Vt;          alpha*rad2deg; beta*rad2deg;
            PN;          PE;            H;
            P*rad2deg;   Q*rad2deg;     R*rad2deg;
            phi*rad2deg; theta*rad2deg; psi*rad2deg;
            (theta - alpha) * rad2deg
    ];
% end mdlOutputs
